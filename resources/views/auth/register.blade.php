            ...
            <form method="POST" action="{{route('register')}}">
                ...
                <div class="input">
                    ...
                    <input type="text" id="name" class="block mt-1 w-full" type="text" name="name"
                        ...
                        @error('name') <span class="text-danger mt-3">{{$error}} </span> @enderror
                </div>
                ...
                <div class="input">
                    ...
                    <input type="text" id="phone" class="block mt-1 w-full" type="text" name="phone"
                        ...
                        @error('phone') <span class="text-danger mt-3">{{$error}} </span> @enderror
                </div>
                ...
                <div class="input">
                    ...
                    <input type="email" id="emailname" class="block mt-1 w-full" type="email" name="email"
                        ...
                        @error('email') <span class="text-danger mt-3">{{$error}} </span> @enderror
                </div>
                ...
                <div class="input">
                    ...
                    <input type="password" id="pass" class="block mt-1 w-full" name="password" required=""
                        ...
                        @error('password') <span class="text-danger mt-3">{{$error}} </span> @enderror
                </div>
